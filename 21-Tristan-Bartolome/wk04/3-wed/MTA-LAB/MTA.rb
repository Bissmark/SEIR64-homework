...
# create a function that plans trip
def plan_trip (starting_line, starting_station, end_line, end_station)
trip = []

if starting_line.to_s == end_line.to_s
    indexStart = lines[starting_line].index(starting_station)
    indexEnd = lines [end_line].index(end_station)
...
plan_trip( :"N", "34th", :"6", "Astor Place")
# MTA Lab
# Objectives:
