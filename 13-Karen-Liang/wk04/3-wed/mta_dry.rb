...
def plan_trip (start_line, trip_a, change_line, trip_b, line)
    ...
    if change_line == " "
        ...
        # STOPS IN BETWEEN
        #----------------------
        if index_a < index_interchange    # travelling forward
        ...
        else index_interchange < index_a   # travelling backward
        ...
        # num_a/b and interchange_stop a/b already added +1 to count of index 0 spots
